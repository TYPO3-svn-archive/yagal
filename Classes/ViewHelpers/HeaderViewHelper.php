 ...
 */
class Tx_Yagal_ViewHelpers_HeaderViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
 ...
 */
    ...
    public function render() {
        $currentResponse = $this->controllerContext->getResponse();
        $currentResponse->addAdditionalHeaderData($this->renderChildren());
        return '';
    }
}
